...
* **Diseño y desarrollo asistido con IA:** Colaboración y asistencia en desarrollo mediante IA para la estructuración de maquetado, optimización de estilos y resolución de problemas técnicos.
* **Frontend:** HTML5 semántico, CSS3 (Flexbox, CSS Grid, CSS Variables, Media Queries)
* **Lógica & Interacción:** JavaScript (ES6+), Vanilla JS (Gestión de i18n, carrusel dinámico, animaciones de scroll)
* **Accesibilidad & SEO:** Atributos ARIA, sintaxis semántica, metas optimizadas
...
* **Internacionalización (i18n):** Selector dinámico para alternar de forma fluida entre español e inglés sin recargar la página.
* **Diseño Responsive:** Layout adaptado a dispositivos móviles, tablets y escritorio.
* **Navegación Fluida:** Scroll suave (`scroll-behavior: smooth`) con compensación de altura (`scroll-margin-top`) para el encabezado fijo.
